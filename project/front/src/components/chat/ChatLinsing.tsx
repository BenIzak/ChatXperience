...
export default function ChatList() {
    return (
        <div className="h-full rounded-lg bg-white px-6 py-8 shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                className={`absolute right-0 top-full z-40 w-[200px] space-y-1 rounded bg-white p-2 shadow-card dark:bg-dark ${dropdownOpen === true ? "block" : "hidden"
                    }`}
            >
    ...
    return (
        <div className="flex cursor-pointer items-center rounded-[5px] px-4 py-[10px] hover:bg-gray-1 dark:hover:bg-dark-3">
            <div className="relative mr-[14px] h-11 w-full max-w-[44px] rounded-full">
                ...
                />
                <span
                    className={`absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 dark:border-dark-2 ${active ? "bg-green" : "bg-red"
                        }`}
                ></span>
            </div>
